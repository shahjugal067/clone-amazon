...
export default function CartAddItem({itemId}:{
    itemId:string
}) {
    const {
                        ...
                        <CardContent className="flex h-full items-center justify-center gap-3 py-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold flex gap-2 my-2" >
                                    <CheckCircle2Icon className="h-6 w-6 text-green-800" />
                                    Added to cart
                                </h3>
                                <p className="text-sm">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                <div className="flex justify-center items-center"> 
                                    {itemsPrice < FREE_SHIPPING_MIN_PRICE ? (
                                        ...
                                        <ProductPrice price={FREE_SHIPPING_MIN_PRICE - itemsPrice} plain/>
                                            </span> {' '} of eligible items to your order to quality for FREE shipping
                                            </div>
                                    ) : ( 
                                        <div className=" flex items-center">
                                            <div>
                                                ...
                                                </span>{' '} Choose this option at checkout
                                            </div>
                                        </div>
                                    )}
                                ...
                                <div className="lg:border-l lg:border-muted lg:pl-3 flex flex-col items-center gap-3">
                                    <div className="flex gap-3">
                                        ...
                                        <ProductPrice className="text-2xl" price={itemsPrice} plain/>
                                    </div>
