...
export async function generateMetadata(props:{
 ...
 export default async function ProductDeatails(props:{
    params: Promise<{slug: string}>
                        ...
                        <div className="flex flex-col gap-3">
                            <p className=" p-medium-16 rounded-full bg-gray-500/10 text-gray-500">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    numReviews={product.numReviews} asPopover 
                                ...
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                                    <div className="flex gap-3">
                                        ...
                                        isDeal={product.tags.includes('todays-deal')} forListing={false}/>
                                    </div>
                                </div>
                            </div>
                        <div>
                            <SelectVariant product={product} size={size || product.sizes[0]}
