...
import { createUpdateReview, getReviewByProductId, 
    getReviews } from "@/lib/actions/review.actions"
import { IProduct } from "@/lib/db/models/product.model"
import { ReviewInputSchema } from "@/lib/validator"
import { IReviewDatails } from "@/types"
...
export default function ReviewList({
    ...
    const [reviews,setReviews] = useState<IReviewDatails[]>([])
        ...
        <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="flex flex-col gap-2">
                    {reviews.length !== 0 && (
                        <RatingSummary avgRating={product.avgRating} 
                    ...
                    {userId ? (
                                ...
                                <Form {...form}>
                                    <form method="post" onSubmit={form.handleSubmit(onSubmit)}>
                                        <DialogHeader>
                                            ...
                                            <DialogDescription>Share your thoughts with other custoers</DialogDescription>
                                        </DialogHeader>
                        ...
                        <div>
                            ...
                            className="highlight-link"> sign in</Link>{' '}
                            to write a review
                        </div>
                    )}
                    </div>
                    ...
                    <div className="md:col-span-3 flex flex-col gap-3">
                        {reviews.map((review: IReviewDatails) =>(
                            <Card key={review._id}>
                                <CardHeader>
                        ...
                        <div ref={ref}>
                            {page <= totalPages && (
                                <Button variant={'link'} onClick={loadMoreReviews}>See More review</Button>
                            )}
