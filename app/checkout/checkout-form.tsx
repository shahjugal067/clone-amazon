            ...
            {!isAddressSelected && (
                <div className="border-b mb-4">
                    ...
                    <p className="text-sm text-center py-2">
                        Choose a shipping address and payment method in order to 
            ...
            {isAddressSelected && !isPaymentMethodSelected && (
                <div className="mb-4">
                    ...
                    <p>
                        ...
                        you can still have  chance to review and dit your order before it&apos;s placed
                    </p>
                </div>
            )}
            {isPaymentMethodSelected && isAddressSelected && (
                <div>
                    <Button onClick={handlePlceOrder} className="rounded-full w-full">
                        Place Your Order
                    </Button>
                    <p>
                        By placing your order you agree to {APP_NAME}&apos;s{' '}
                        <Link href={'/page/privacy-policy'}>policy notice</Link> and
                ...
                <div>
                    {isAddressSelected && shippingAddress ? (
                        ...
                        <Form {...shippingAddressForm}>
                            <form method="post" onSubmit={shippingAddressForm.handleSubmit(onSubmitShippingAddress)}
                            className="space-y-4">
                                <Card className="md:ml-8 my-4">
                                    <CardContent className="p-4 space-y-2">
                                        ...
                                        <div className="flex flex-col gap-5 md:flex-row">
                                            <FormField control={shippingAddressForm.control} name="city"
                                             render={({ field }) => (
                                                <FormItem className='w-full'>
                                            ...
                                            <FormField control={shippingAddressForm.control} name="province"
                                             render={({ field }) => (
                                                <FormItem className='w-full'>
                                        ...
                                        <div className="flex flex-col gap-5 md:flex-row">
                                            <FormField control={shippingAddressForm.control} name="postalCode"
                                             render={({ field }) => (
                                                <FormItem className='w-full'>
                                            ...
                                            <FormField control={shippingAddressForm.control} name="country"
                                             render={({ field }) => (
                                                <FormItem className='w-full'>
                                        ...
                                        <div className="flex flex-col gap-5 md:flex-row">
                                            ...
                                            <FormField control={shippingAddressForm.control} name="phone"
                                             render={({ field }) => (
                                                <FormItem className='w-full'>
                                       ...
                                       <CardFooter className="p-4">
                                        <Button type="submit" className="rounded-full font-bold bg-yellow-500">
                                            Ship to this address
                                        </Button>
                                       </CardFooter>
                                </Card>
                ...
                {/* payment method */}
                    ...
                    {isPaymentMethodSelected && paymentMethod ? (
                        ...
                        <Card className="md:ml-8 my-4">
                                ...
                                onValueChange={(value) => setPaymentMethod(value)}>
                                    {AVAILABLE_PAYMENT_METHODS.map((pm)=>(
                                        <div key={pm.name} className="flex items-center py-1" >
                                            ...
                                            <Label className="font-bold pl-2 cursor-pointer"
                            ...
                            <CardFooter className="p-4">
                                <Button onClick={handleSelectPaymentMethod} 
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <div className="font-bold">
                                                ...
                                                <ul>
                                                    <RadioGroup value={AVAILABLE_DELIVERY_DATES[deliveryDateIndex!].name}
                                                    onValueChange={(value)=> setDeliveryDateIndex(
                                ...
                                <CardContent className="p-4 flex flex-col md:flex-row justify-between items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs">
                                            {' '}
                                            By placing your order ,you agree to {APP_NAME}&apos;s 
                                            <Link href='/page/privacy-policy'>Privacy notice
                                            </Link>{' '} and
